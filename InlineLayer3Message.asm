...
; These are just vanilla defines
...
!EmptyTile = $1F				; The tile to draw when nothing is drawn
!EnableSwitchPalace = 1			; If set to 1: Display dotted and exclamation mark blocks if switch palace
